...
\fsgraphics{
    \centering
    \includegraphics[width=0.4\textwidth]{images/upone0}
    \includegraphics[width=0.4\textwidth]{images/upone1}
    \graphicscaption{Links: Schlichtes Design des UPone, Rechts: modernste Technik, kompakt verpackt.}
}
